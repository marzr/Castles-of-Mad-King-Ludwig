...
val filesMap = mapOf(
    ...
    "Теплица" to "Outdoor/BC_oranzeria.png",
    "Парадные сады" to "Outdoor/LR_formal_gardens.png",
    "Каретный гараж" to "Outdoor/LR_carriage_garage.jpg",
    "Привратницкая" to "Outdoor/MR_gatekeeper_TODO.png",
    "Крыльцо" to "Outdoor/MR_porch.png",
    "Сарай" to "Outdoor/MR_shed.png",
    "Террасы" to "Outdoor/Oct_terrace.png",
    "Конюшни" to "Outdoor/Oct_stables.png",
    //"Французская беседка" to "Outdoor/Sq_pavilion.png", TODO
    "Сад тыкв" to "Outdoor/Sq_pumpkin_garden.png",

    //"" to "image/Sleeping/L_krola.png", TODO
    "Спальня королевы" to "Sleeping/L_queen.png",
    "Комната Тассо" to "Sleeping/L_tasso.png",
    "Большая спальня" to "Sleeping/Sq_grand_bedchamber.png",
    "Комната для слуг" to "Sleeping/Sq_servants_quarters.png",
    "Комната отдыха" to "Sleeping/SR_nap_room.png",
    "Солярий" to "Sleeping/SR_solar.png",
    "Гардеробная" to "Sleeping/SR_wardrobe_Copied_Fixed_TODO.png",
